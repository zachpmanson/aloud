...
Works very well with [readable](https://gitlab.com/gardenappl/readability-cli) ([maybe integrate natively?](https://github.com/philipjkim/goreadability)). Can be piped like so:
